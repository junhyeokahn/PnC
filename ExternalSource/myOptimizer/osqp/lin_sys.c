...
#include "ExternalSource/myOptimizer/osqp/qdldl_interface.h" // Include only this solver in the same directory
...
# include "ExternalSource/myOptimizer/osqp/pardiso_interface.h"
# include "ExternalSource/myOptimizer/osqp/pardiso_loader.h"
