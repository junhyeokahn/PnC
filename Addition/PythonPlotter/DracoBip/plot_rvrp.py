...
for i in range(1,4,1):
    ...
    plt.plot(data_x, data_r_vrp_pos[st_idx:end_idx,i-1], "b-")
...
plt.plot(data_r_vrp_pos[st_idx:end_idx,0], data_r_vrp_pos[st_idx:end_idx,1], "b-")
plt.plot(data_r_vrp_pos_des[st_idx:end_idx,0], data_r_vrp_pos_des[st_idx:end_idx,1], "r-")
plt.plot(data_dcm_pos[st_idx:end_idx,0], data_dcm_pos[st_idx:end_idx,1], "k-")
plt.plot(data_dcm_pos_des[st_idx:end_idx,0], data_dcm_pos_des[st_idx:end_idx,1], "c-")
