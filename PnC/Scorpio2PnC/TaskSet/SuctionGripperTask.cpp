...
SuctionGripperTask2::SuctionGripperTask2(RobotSystem* robot) : Task(robot, 2) {
    myUtils::pretty_constructor(3, "Suction Gripper2 Task");
...
SuctionGripperTask2::~SuctionGripperTask2() {}

bool SuctionGripperTask2::_UpdateCommand(const Eigen::VectorXd& _pos_des,
...
bool SuctionGripperTask2::_UpdateTaskJDotQdot() {
    JtDotQdot_.setZero();
    return true;
}
