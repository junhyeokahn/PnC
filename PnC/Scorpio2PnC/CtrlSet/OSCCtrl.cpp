...
#include <PnC/Scorpio2PnC/TaskSet/SuctionGripperTask.hpp>

OSC2Ctrl::OSC2Ctrl(RobotSystem* _robot) : Controller(_robot) {
    myUtils::pretty_constructor(2, "OSC2 POS Ctrl");
    end_time_ = 0;
...
void OSC2Ctrl::oneStep(void* _cmd) {
...
void OSC2Ctrl::_compute_torque(Eigen::VectorXd & gamma){
    _build_constraint_matrix();
...
void OSC2Ctrl::lastVisit() {
}

bool OSC2Ctrl::endOfPhase() {
...
void OSC2Ctrl::ctrlInitialization(const YAML::Node& node) {
    try {
