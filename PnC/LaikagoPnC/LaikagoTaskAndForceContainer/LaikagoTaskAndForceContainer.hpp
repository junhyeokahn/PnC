...
#include <PnC/LaikagoPnC/LaikagoTask/CoMxyz.hpp>
#include <PnC/LaikagoPnC/LaikagoTask/CoMz.hpp>
#include <PnC/LaikagoPnC/LaikagoTask/DCMTask.hpp>
#include <PnC/LaikagoPnC/LaikagoTask/FootLocalRyRzTask.hpp>
#include <PnC/LaikagoPnC/LaikagoTask/TorsoRxRy.hpp>
...
class LaikagoTaskAndForceContainer : public TaskAndForceContainer {
 public:
  LaikagoTaskAndForceContainer(RobotSystem* _robot);
  ~LaikagoTaskAndForceContainer();
