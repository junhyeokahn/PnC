...
// 1) initializeRampToMin/Max in the initialization step with the current time and nominal ramp duration
...
class TaskGainScheduleTrajectoryManager : public TrajectoryManagerBase {
  public:
    ...
    void initializeRampToMin(const double start_time, const double nominal_ramp_duration);
