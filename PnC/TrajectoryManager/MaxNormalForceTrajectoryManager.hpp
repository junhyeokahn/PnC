...
// 1) initializeRampToZero/Max in the initialization step with the current time
...
class MaxNormalForceTrajectoryManager : public TrajectoryManagerBase {
 public:
  ...
  void initializeRampToZero(const double start_time,
  ...
  double current_max_normal_force_z_;  // current normal force value to update
                                       // contact spec
