...
#include <towr_plus/models/examples/nao_crbi_helper.h>

namespace towr_plus {

class NaoCompositeRigidBodyInertia : public CompositeRigidBodyInertia {
public:
  NaoCompositeRigidBodyInertia();
  virtual ~NaoCompositeRigidBodyInertia();
