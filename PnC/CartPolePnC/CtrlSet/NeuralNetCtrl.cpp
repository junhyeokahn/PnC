...
void NeuralNetCtrl::SendRLData_(){
    // =========================================================================
    ...
    // set done
    bool done(false);
    if ( (robot_->getQ()[0] < obs_lower_bound_[0]) ||
         (robot_->getQ()[0] > obs_upper_bound_[0]) ||
         (robot_->getQ()[1] < obs_lower_bound_[1]) ||
         (robot_->getQ()[1] > obs_upper_bound_[1]) )
    {
        done = true;
    }
