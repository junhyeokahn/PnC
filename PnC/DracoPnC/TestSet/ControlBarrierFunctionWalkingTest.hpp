...
class ControlBarrierFunctionWalkingTest : public Test {
   public:
    ControlBarrierFunctionWalkingTest(RobotSystem*);
    virtual ~ControlBarrierFunctionWalkingTest();
