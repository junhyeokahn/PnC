...
class IVDJPosTargetCtrl: public Controller{
    public:
        IVDJPosTargetCtrl(RobotSystem* _robot);
        virtual ~IVDJPosTargetCtrl();
        ...
        void setTotalCtrlTime(double time) { ctrl_time_ = time; }
