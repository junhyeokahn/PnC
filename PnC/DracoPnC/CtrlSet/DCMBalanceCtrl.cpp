...
DCMBalanceCtrl::~DCMBalanceCtrl() {
    ...
    delete rfoot_line_task;
    delete lfoot_line_task;
    delete rfoot_front_task;
    delete rfoot_back_task;
    delete lfoot_front_task;
    delete lfoot_back_task;
    delete ang_momentum_task;
