...
WalkingTest::WalkingTest(RobotSystem* robot) : Test(robot) {
    ...
    cfg_ = YAML::LoadFile(THIS_COM "Config/Atlas/TEST/WALKING_SIM_TEST.yaml");
    ...
    right_swing_ctrl_ = new BodyFootPlanningCtrl(robot_, AtlasBodyNode::r_sole,
                                                 reversal_planner_);
    left_swing_ctrl_ = new BodyFootPlanningCtrl(robot_, AtlasBodyNode::l_sole,
                                                reversal_planner_);
    _SettingParameter();
