...
class WBMPC: public WBC{
    public:
        WBMPC(const std::vector<bool> & act_list, const Eigen::MatrixXd* Jci = NULL);
        virtual ~WBMPC(){}
        
        virtual void setupMPC(const int h_pred, const int h_ctrl);
