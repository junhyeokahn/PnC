...
DracoTCIContainer::DracoTCIContainer(RobotSystem *_robot)
  ...
  com_task->kp =
      util::ReadParameter<Eigen::VectorXd>(cfg["wbc"]["task"]["com"], "kp");
  com_task->kd =
      util::ReadParameter<Eigen::VectorXd>(cfg["wbc"]["task"]["com"], "kd");
