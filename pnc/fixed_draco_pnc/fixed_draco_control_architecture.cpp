...
FixedDracoControlArchitecture::FixedDracoControlArchitecture(RobotSystem *_robot)
  ...
  state_machines[fixed_draco_states::kSwaying] =
      new EndEffectorSwaying(fixed_draco_states::kSwaying, this, EndEffector::RFoot, robot_);
  ((EndEffectorSwaying *)state_machines[fixed_draco_states::kSwaying])->amp =
      util::ReadParameter<Eigen::Vector3d>(cfg["ee_swaying"], "swaying_amp");
  ((EndEffectorSwaying *)state_machines[fixed_draco_states::kSwaying])->freq =
      util::ReadParameter<Eigen::Vector3d>(cfg["ee_swaying"], "swaying_freq");


  state = fixed_draco_states::kSwaying;
  prev_state = fixed_draco_states::kSwaying;
...
FixedDracoControlArchitecture::~FixedDracoControlArchitecture() {
  ...
  delete state_machines[fixed_draco_states::kSwaying];
}
