#include "pnc/planners/locomotion/centroid_planner/centroid_planner.hpp"
//#include "Utils/Math/minjerk_one_dim.hpp"

using namespace util;
using namespace solver;

CentroidPlannerParameter::CentroidPlannerParameter(YAML::Node planner_cfg, double robot_mass) {
    util::PrettyConstructor(2, "Centroidal Planner");
...
CentroidPlanner::CentroidPlanner(CentroidPlannerParameter* _param) {
    mCentParam = _param;
}
