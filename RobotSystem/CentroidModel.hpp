...
public:
    ...
    static std::string eEfIdToString(int eefId_) {
        switch (eefId_) {
            case static_cast<int>(EEfID::rightFoot): { return std::string("rf"); break; }
            case static_cast<int>(EEfID::leftFoot): { return std::string("lf"); break; }
            case static_cast<int>(EEfID::rightHand): { return std::string("rh"); break; }
            case static_cast<int>(EEfID::leftHand): { return std::string("lh"); break; }
