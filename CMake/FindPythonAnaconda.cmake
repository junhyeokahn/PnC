...
if(NOT CMAKE_FIND_ANACONDA_PYTHON_INCLUDED)
  ...
  if(ANACONDA_PYTHON_FOUND)
    ...
    if( env_CONDA_DEFAULT_ENV STREQUAL "root" )
      ...
      set(PYTHON_EXECUTABLE "${ANACONDA_PYTHON_DIR}/bin/${_py_id}" CACHE INTERNAL "")
    else()
      ...
      set(PYTHON_EXECUTABLE "${ANACONDA_PYTHON_DIR}/envs/${env_CONDA_DEFAULT_ENV}/bin/${_py_id}" CACHE INTERNAL "")
    endif()
