...
// void HermiteCurve::Initialize(const double &start_pos, const double
// &start_vel, const double &end_pos, const double &end_vel) {
// p1_ = start_pos;
// p2_ = end_pos;
// v1_ = start_vel;
// v2_ = end_vel;
...
// { for (int i = 0; i < p1_.size(); i++) { output_[i] =
// curves_[i].EvaluateFirstDerivative(s_in);
//}
// return output_;
//}
...
// { for (int i = 0; i < p1_.size(); i++) { output_[i] =
// curves_[i].EvaluateSecondDerivative(s_in);
//}
// return output_;
//}
