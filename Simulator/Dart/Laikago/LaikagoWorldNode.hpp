...
class LaikagoWorldNode : public dart::gui::osg::WorldNode {
 private:
  EnvInterface* interface_;
  LaikagoSensorData* sensor_data_;
  LaikagoCommand* command_;
 ...
 public:
  LaikagoWorldNode(const dart::simulation::WorldPtr& world);
  virtual ~LaikagoWorldNode();
