...
{
public:
    OneStepProgress(DracoHipWorldNode* worldnode): worldnode_(worldnode){  }
...
int main() {
    ...
    // ========================
    ParamHandler handler(THIS_COM"Config/DracoHip/SIMULATION.yaml");
    bool isRecord;
    ...
    // Wrap a worldnode
    // ================
    osg::ref_ptr<DracoHipWorldNode> node
        = new DracoHipWorldNode(world, msm);
