...
class PositionMeasurementModel
   ...
   public:
     ...
     */
    PositionMeasurementModel(T landmark1x, T landmark1y, T landmark2x,
                             T landmark2y) {
    ...
    M h(const S& x) const {
        ...
        // This uses the Eigen template method to get the first 2 elements of
        // the vector
   ...
   protected:
     ...
     * matrices to linearize the non-linear measurement function \f$h(x)\f$
