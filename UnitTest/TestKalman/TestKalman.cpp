...
#include "UnitTest/TestKalman/OrientationMeasurementModel.hpp"
#include "UnitTest/TestKalman/PositionMeasurementModel.hpp"

#include <Filters/Kalman/ExtendedKalmanFilter.hpp>
#include <Filters/Kalman/UnscentedKalmanFilter.hpp>
...
int main(int argc, char** argv)
{
    ...
    for(size_t i = 1; i <= N; i++)
    {
        ...
        // Orientation measurement
        {
            ...
            OrientationMeasurement orientation = om.h(x); // <-- Oracle gives it to you
